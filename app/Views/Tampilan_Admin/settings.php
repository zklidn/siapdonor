        ...
        <form action="<?= base_url('admin/update_profil') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 25px;">
                ...
                <div style="display: flex; align-items: center; gap: 15px;">
                    <div style="width: 60px; height: 60px; border-radius: 50%; background: #f3f4f6; border: 1px solid #e5e7eb; display: flex; justify-content: center; align-items: center; overflow: hidden;">
                        <i class="fa-solid fa-user" style="font-size: 24px; color: #9ca3af;"></i>
                        </div>
                    <div>
                        <input type="file" name="foto_profil" accept="image/*" style="padding: 8px 12px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 13px; outline: none; background: #f9fafb;">
                        <small style="display: block; font-size: 11px; color: #6b7280; margin-top: 5px;">Format: JPG, PNG (Maks 2MB)</small>
                    </div>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr auto; gap: 20px; align-items: end;">
                ...
                <div>
                    ...
                    <input type="text" name="nama" value="RS Bhakti Agung" style="width: 100%; padding: 12px 15px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 13px; outline: none; color: #1f2937;">
                </div>

                <div>
                    <label style="display: block; font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 8px;">Email</label>
                    <input type="email" name="email" value="rsbhaktiagung@gmail.com" style="width: 100%; padding: 12px 15px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 13px; outline: none; color: #1f2937;">
                </div>
