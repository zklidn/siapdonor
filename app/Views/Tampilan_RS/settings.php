        ...
        <form action="<?= base_url('rs/update_profil') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr auto; gap: 20px; align-items: end;">
                ...
                <div>
                    ...
                    <input type="text" name="nama" value="RS Wahidin" style="width: 100%; padding: 12px 15px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 13px; outline: none; color: #1f2937;">
                </div>

                <div>
                    <label style="display: block; font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 8px;">Email</label>
                    <input type="email" name="email" value="rswahidin@gmail.com" style="width: 100%; padding: 12px 15px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 13px; outline: none; color: #1f2937;">
                </div>
